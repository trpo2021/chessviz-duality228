...
TEST_CASE("Testing for Chess Pawn ", "[Chess]")
{
    ...
    REQUIRE(pawn(b, 8, 8, a) == 4); // hod na 1 kletku
    a[1] = 'b';
    a[2] = '2';
    a[3] = '-';
    a[4] = 'a';
    ...
    REQUIRE(pawn(b, 8, 8, a, 6) == 5); // proverka hoda po diagonali
    a[1] = 'b';
    a[2] = '2';
    a[3] = '-';
    a[4] = 'a';
    ...
    REQUIRE(pawn(b, 8, 8, a, 6) == 5); // proverka hoda na 3 kletki
    a[1] = 'a';
    a[2] = '2';
    a[3] = '-';
    a[4] = 'a';
    ...
    REQUIRE(pawn(b, 8, 8, a, 6) == 5); // proverka hoda esli vperedi figura
    a[1] = 'a';
    a[2] = '2';
    a[3] = '-';
    a[4] = 'a';
    ...
    REQUIRE(pawn(b, 8, 8, a, 6) == 5); // proverka hoda nazad
    a[1] = 'c';
    a[2] = '2';
    a[3] = 'x';
    a[4] = 'd';
    ...
    REQUIRE(pawn(b, 8, 8, a, 6) == 4); // proverka s'edaniya figuri
    a[1] = 'e';
    a[2] = '2';
    a[3] = 'x';
    a[4] = 'd';
    ...
    REQUIRE(pawn(b, 8, 8, a, 6) == 5); // proverka s'edaniya figuri
}
TEST_CASE("Testing for Chess Knight ", "[Chess]")
{
    ...
    cout << "Test 1   -   Okey" << endl;
    REQUIRE(kNight(b, 8, 8, a) == 4); // proverka hoda bukvoi �
    a[1] = 'b';
    a[2] = '1';
    a[3] = '-';
    a[4] = 'a';
    a[5] = '3';
    cout << "Test 2   -   Okey" << endl;
    REQUIRE(kNight(b, 8, 8, a) == 4); // proverka hoda bukvoi � v levo
    a[1] = 'e';
    a[2] = '1';
    a[3] = '-';
    a[4] = 'c';
...
TEST_CASE("Testing for Chess King ", "[Chess]")
{
    ...
    cout << "Test 1   -   Okey" << endl;
    REQUIRE(king(b, 8, 8, a) == 4); // proverka hoda vniz
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'c';
    a[5] = '5';
    cout << "Test 2   -   Okey" << endl;
    REQUIRE(king(b, 8, 8, a) == 4); // proverka hoda vverh
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'c';
    a[5] = '3';
    cout << "Test 3   -   Okey" << endl;
    REQUIRE(king(b, 8, 8, a) == 4); // proverka hoda po vertikaly
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'd';
    a[5] = '3';
    cout << "Test 4   -   Okey" << endl;
    REQUIRE(king(b, 8, 8, a) == 4); // proverka hoda po diagonaly
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'c';
    ...
    a[5] = '4';
    cout << "Test 6   -   Okey" << endl;
    REQUIRE(king(b, 8, 8, a) == 4); // proverka s'edaniya
}
TEST_CASE("Testing for Chess Queen ", "[Chess]")
{
    ...
    a[5] = '1';
    cout << "Test 2   -   Okey" << endl;
    REQUIRE(queen(b, 8, 8, a) == 4); // proverka hoda po vetikali
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'a';
    a[5] = '4';
    cout << "Test 3   -   Okey" << endl;
    REQUIRE(queen(b, 8, 8, a) == 4); // proverka hoda po gorizontali
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'g';
    ...
    a[5] = '7';
    cout << "Test 5   -   Okey" << endl;
    REQUIRE(queen(b, 8, 8, a) == 4); // proverka hoda po diagonali
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'd';
    ...
    a[5] = '4';
    cout << "Test 7   -   Okey" << endl;
    REQUIRE(queen(b, 8, 8, a) == 4); // proverka s'edaniya
}
TEST_CASE("Testing for Chess Bishop ", "[Chess]")
{
    ...
    a[5] = '6';
    cout << "Test 2   -   Okey" << endl;
    REQUIRE(bishop(b, 8, 8, a) == 4); // proverka hoda po diagonali
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'c';
    ...
    a[5] = '6';
    cout << "Test 5   -   Okey" << endl;
    REQUIRE(bishop(b, 8, 8, a) == 4); // proverka s'edaniya
}
TEST_CASE("Testing for Chess Rook ", "[Chess]")
{
    ...
    cout << "Test 1   -   Okey" << endl;
    REQUIRE(rook(b, 8, 8, a) == 4); // proverka hoda po vertikali
    a[1] = 'c';
    a[2] = '4';
    a[3] = '-';
    a[4] = 'a';
    ...
    a[5] = '4';
    cout << "Test 5   -   Okey" << endl;
    REQUIRE(rook(b, 8, 8, a) == 4); // proverka s'edaniya
}
